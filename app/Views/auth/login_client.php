...
<head>
    ...
    <title>Client Login | Online Appointment Booking</title>
...
<div class="container px-3">
    <div class="login-card bg-white p-4 p-md-5 mx-auto">
        <div class="mb-3 text-center">
            ...
            <h1 class="h4 fw-bold text-slate-900 mb-1">Client Login</h1>
            <span class="badge-role">Patient Portal</span>
        </div>
        ...
        <form action="<?= site_url('/login') ?>" method="post" class="mt-2">
            ...
            <p class="text-center text-muted small-text mb-2">
            ...
            <p class="text-center text-muted small-text mb-0">
                ...
                <a href="<?= site_url('/admin/login') ?>" class="fw-semibold">Admin Login</a>
            </p>
        </form>
    </div>
</div>
