...
<div class="dashboard-wrapper">
    ...
    <div class="adm-page">
        <!-- Sidebar -->
        <?= view('admin/_sidebar', ['sidebarActive' => 'dashboard']) ?>
...
(function () {
    ...
    window.selectContact = function (el) {
        ...
        // mobile: hide sidebar, show convo
...
<style>
    ...
    .msng-bubble-them {
        background: #e9ecef; color: #0f172a;
...
<style>
    ...
    /* ΓöÇΓöÇ Notifications Panel ΓöÇΓöÇ */
    .notif-panel {
    ...
    /* ΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉ
       ADMIN ΓÇö Steel Blue/Teal Theme
    ΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉ */
    .adm-wrapper {
        background: #dce6ef;
        border-radius: 24px;
    ...
    /* ΓöÇΓöÇ Assistant Admin Compact List ΓöÇΓöÇ */
    .aa-list-panel {
    ...
    /* ΓöÇΓöÇ Availability Schedule Widget ΓöÇΓöÇ */
    .aa-sched-header {
    ...
    /* ΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉ
       SECRETARY ΓÇö Redesigned Green Theme
    ΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉ */
    .sec2-wrapper {
        background: #f4f9f4;
        border-radius: 20px;
