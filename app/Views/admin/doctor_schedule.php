...
<div class="dashboard-wrapper">
    <div class="adm-page">
        ...
        <div class="adm-sidebar">
            ...
            <a href="<?= site_url('/admin/doctor-schedules') ?>" class="adm-nav-item active">
...
<style>
    ...
    .pl-btn-filled { background: #1e3a8a; color: white; }
    .pl-btn-filled:hover { background: #1e40af; color: white; }
